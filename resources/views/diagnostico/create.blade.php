...
@section('contenido')                
			<div class="row well">
            	...
            	<div class="page-header">
            		<h3>Nuevo <span class="violet">Diagnóstico</span></h3>
				</div>

                {!!Form::open(array('url'=>'diagnostico', 'method'=>'POST', 'autocomplete'=>'off'))!!}
                {{Form::token()}}
                ...
                <div class="row">
                    	...
                    	<div class="col-md-8">
                			<div class="form-group has-feedback">
                				...
                				<div class="input-group input-group-sm">
                    				<span class="input-group-addon "><span class="fa fa-user"></span></span>
                    				<input name="nombre" id="nombre" type="text" class="form-control" placeholder="Nombre de diagnóstico" onKeyUp="this.value=this.value.toUpperCase();">
                    				<span class="glyphicon form-control-feedback" aria-hidden="true"></span>
                				</div>
           					</div>
                    	</div>                        
