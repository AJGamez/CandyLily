...
@section('contenido')
			<div class="row well">
            	...
            	<div class="page-header">
            		<h3>Nueva <span class="violet">Unidad</span></h3>
				</div>

                {!!Form::open(array('url'=>'unidad', 'method'=>'POST', 'autocomplete'=>'off'))!!}
                {{Form::token()}}
                    	...
                    	<div class="col-md-8">
                			<div class="form-group has-feedback">
                				...
                				<div class="input-group input-group-sm">
                    				...
                    				<input name="nombre" id="nombre" type="text" class="form-control" placeholder="Nombre de Unidad" onKeyUp="this.value=this.value.toUpperCase();">
