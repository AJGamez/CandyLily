<div class="modal fade modal-slide-in-right" aria-hidden="true" role="dialog" tabindex="-1" id="delete-{{$con->id}}">
    {{Form::Open(array('action'=>array('UsuarioController@destroy', $con->id), 'method'=>'delete'))}}
